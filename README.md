<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Kiblasalat&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Kiblasalat Header Banner" />
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/kiblasalat"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Kiblasalat** is a high-performance, native Android application engineered with **Android Jetpack Compose** for maximum responsiveness, fluid motion, and robust state persistence.
